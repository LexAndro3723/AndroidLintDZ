...
import ru.dz.lintchecks.JobInBuilderUsageDetector
        ...
        testLintTask
            .files(
                LintDetectorTest.kotlin(
                    """
                        package ru.dz.lint.jobinbuilderusage
            ...
            .expect(
                """
                    src/ru/dz/lint/jobinbuilderusage/JobInBuilderTestCase.kt:14: Warning: Job/SupervisorJob нельзя передавать в корутин-билдер [JobInBuilderUsage]
        viewModelScope.launch(SupervisorJob() + Dispatchers.IO) {
                              ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
0 errors, 1 warnings
                """.trimIndent()
    ...
    fun `check detect Job usage`() {
        testLintTask
            ...
            .expect(
                """
                    src/ru/dz/lint/jobinbuilderusage/JobInBuilderTestCase.kt:12: Warning: Job/SupervisorJob нельзя передавать в корутин-билдер [JobInBuilderUsage]
                            viewModelScope.launch(Job()) {
                                                  ~~~~~
                    0 errors, 1 warnings
                """.trimIndent()
    ...
    fun `should detect Job usage case4`() {
        testLintTask
            ...
            .expect(
                """
                    src/ru/dz/lint/jobinbuilderusage/JobInBuilderTestCase.kt:13: Warning: Job/SupervisorJob нельзя передавать в корутин-билдер [JobInBuilderUsage]
                            viewModelScope.launch(NonCancellable) {
                                                  ~~~~~~~~~~~~~~
                    0 errors, 1 warnings
                """.trimIndent()
