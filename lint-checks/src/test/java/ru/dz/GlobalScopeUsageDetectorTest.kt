...
import ru.dz.lintchecks.GlobalScopeUsageDetector
...
class GlobalScopeUsageDetectorTest {
        ...
        testLintTask
            .files(
                LintDetectorTest.kotlin(
                    """
                    package ru.dz.lint.globalscopeusage
            ...
            .expect(
                """
                    src/ru/dz/lint/globalscopeusage/GlobalScopeTestCase.kt:12: Warning: Использование GlobalScope может привести к утечкам памяти [GlobalScopeUsage]
                            GlobalScope.launch {
                            ^
                    src/ru/dz/lint/globalscopeusage/GlobalScopeTestCase.kt:16: Warning: Использование GlobalScope может привести к утечкам памяти [GlobalScopeUsage]
                            GlobalScope.actor<String> {
                            ^
                    0 errors, 2 warnings
                """.trimIndent()
    ...
    fun `check usage global scope into view model scope`() {
        testLintTask
            ...
            .expect(
                """
                    src/ru/dz/lint/globalscopeusage/GlobalScopeTestCase.kt:15: Warning: Использование GlobalScope может привести к утечкам памяти [GlobalScopeUsage]
                                val deferred = GlobalScope.async {
                                               ^
                    0 errors, 1 warnings
                """.trimIndent()
